        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="form-group"><label>Payment Instructions (sent with reminders)</label><textarea className="form-input" style={{ minHeight: 100 }} value={settings.payment_instructions || ''} onChange={e => update('payment_instructions', e.target.value)} placeholder="Please transfer to:&#10;Name: Deniz&#10;Bank: ...&#10;IBAN: ...&#10;Amount: ... AZN" /></div>
            </div>
          </div>
          <div className="card">
